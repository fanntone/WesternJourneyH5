...
//import com.auer.data.SysLog;
//import com.excel.impl.ExcelData;
//import com.auer.hibernate.game.dao.UserDataDAO;
//import com.auer.hibernate.game.dao.UserFriendDAO;
//import com.auer.hibernate.game.dao.UserItemDAO;
//import com.auer.hibernate.game.dao.UserMapDAO;
//import com.auer.hibernate.game.dao.UserPetDAO;
...
public class HibernateManagement {
	...
	private HibernateManagement() {
		...
		if ( initHibernateConfig() ) {	
			...
			SysLog.PrintInfo("[Success] HibernateManagement 初始化成功....Success!!!");
		}
		else {
			SysLog.PrintInfo("[Failure] HibernateManagement 初始化失敗....Failure!!!");				
		}		
	}
		...
		try
	    {
			...
			if ( rbHibernate != null ) {
			   ...
			   while (enumeration.hasMoreElements()) {
				...
				SysLog.PrintInfo("[Failure] 讀取  hibernate.properties 檔失敗...Failure!!!");
			}
	    }
	    catch (MissingResourceException e)
	    {
	    	SysLog.PrintInfo("[Failure] HibernateManagement.initHibernateConfig() error!! Message = "+e.getMessage());
		    return false;
	    }			
...
//		UserPetDAO.getInstance();
//		UserItemDAO.getInstance();
//		UserFriendDAO.getInstance();		
//		UserMapDAO.getInstance();		
	}
