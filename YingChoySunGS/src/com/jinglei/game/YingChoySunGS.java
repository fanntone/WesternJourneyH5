...
public class YingChoySunGS
{
	...
	{	
		...
		_SERVER_ERROR_: {
			try
			{
				...
				configuration = ResourceBundle.getBundle(YingChoySunGS.SERVER_CONFIGURATION);
				...
				rbLogicType = ResourceBundle.getBundle(YingChoySunGS.LOGIC_TYPE_CONFIG);					
	...
	public static ResourceBundle getResourceBundle() {
		if ( YingChoySunGS.configuration != null ) {
			return YingChoySunGS.configuration;
		}
