 ...
 */
public class DataBaseReadDAO {
	
	/*
	 *  DataBaseReadDAO Instance
	 */
	private static DataBaseReadDAO   instance = null;
	...
	/*
	 *  取得 DataBaseReadDAO  Instance
	 */
	public static synchronized DataBaseReadDAO getInstance()  {
        if (instance == null) {
        	instance = new DataBaseReadDAO();
        }
	        ...
	        if ( session != null ) {	
	        	 ...
	        	 */
	        		...
	        		if ( query_data != null && !query_data.isEmpty()) {
		        		 ...
		        		 */	        			
	        			account_data   rtndata = new account_data(Integer.valueOf(object[0].toString()),
	        													  Integer.valueOf(object[1].toString()),
																  object[2].toString(),
																  object[3].toString(),
																  object[4].toString(),
																  Integer.valueOf(object[5].toString()),
																  Integer.valueOf(object[6].toString()),
																  Integer.valueOf(object[7].toString()),
																  Boolean.valueOf(object[8].toString()),
																  Integer.valueOf(object[9].toString()),
																  Integer.valueOf(object[10].toString()),
																  object[11].toString());        			
